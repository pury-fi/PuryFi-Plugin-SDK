...
export abstract class PuryFiUpstream {
    ...
    private getSet<K extends keyof UpstreamEvents>(type: K): Set<UpstreamEvents[K]> {
     ...
     * @returns 
     */
    addListener<K extends keyof UpstreamEvents>(type: K, callback: UpstreamEvents[K]): this {
     ...
     * @returns 
     */
    off<K extends keyof UpstreamEvents>(type: K, callback: UpstreamEvents[K]): this {
