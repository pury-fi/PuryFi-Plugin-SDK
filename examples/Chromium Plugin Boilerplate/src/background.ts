 ...
 *
 * This is a boilerplate example for building a PuryFi plugin using the Browser Plugin SDK. It sets up the connection, completes the handshake, and provides placeholders for requesting intents, handling configuration, and implementing plugin features.
 */
...
const manifest: PluginManifest = {
   ...
   version: "1.0.0",
   description:
      "Boilerplate for building a PuryFi plugin using the Browser SDK",
   author: null,
   website: null,
};
